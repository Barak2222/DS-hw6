...
/**
 * IMPLEMENTATION COMMENT Since java treats floating point numbers it a certain
 * percision that is not good enough for sorting via radix sort we came up with
 * a solution: We conver all numbers into String and than sort each key inside
 * the String. That is why the running time is relatively long
 */
